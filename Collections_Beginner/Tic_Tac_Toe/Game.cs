...
namespace Tic_Tac_Toe
{
    public class Game
    {
        //using a JAGGED Array  //if list is used insted of array the List<List<Square>>.complicated
        ...
        public void PlayGame()
        {
            ...
            {
                DisplayBoard();
                @continue = PlayMove(player);  //since continue is a C# keyword.use @ before
                if (!@continue)
                    return;
